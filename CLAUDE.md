...
| `lib/cards.ts` | `CARD_SIZES` · `CARD_STYLES` · `renderCard(canvas, input, scale?)` · `mmToPx` · `cardFileName` |
| `pages/dashboard/Cards.tsx` | الاستوديو |
| `pages/dashboard/PrintTabs.tsx` | شريط تبويبَي «الطباعة»: البطاقات · أكواد QR |

القياسات (مليمتر، ×300DPI): `counter` 100×150 · `tent` 100×210 (وجهان، الأعلى
مقلوب ١٨٠° مع خطّ طيّ متقطّع) · `card` 85×55 · `sticker` 80×80.
الأنماط: `dark` · `light` · `brand` (من طابع منيو التاجر) · `heritage` (سدو).
