...
const FEATURES = [
  ...
  { emoji: "🎨", title: "طوابع + لون علامتك", desc: `${THEME_COUNT} طابعاً كاملاً بينها طوابع تراثية سعودية — زخرفة وترويسة وتخطيط وخطّ، أو اختر لون مشروعك وسنبني منه طابعاً متناسقاً.` },
...
const BEATS = [
  ...
  },
  {
    id: "luxe",
    title: "خامة وخطّ",
    desc: `عمق الأسطح ولمعة الذهب وحدّ الحافّة، وخطّ رقعة للعناوين مع خطّ قراءة للأصناف. ${THEME_COUNT} طابعاً — لا اثنان منها متشابهان.`,
  },
] as const;
    ...
    <section id="themes" className="scroll-mt-20 border-y border-line bg-panel/40">
      <div className="mx-auto max-w-6xl px-5 py-16">
        <Reveal className="mb-12 text-center">
          <Badge className="mb-5">🎨 {THEME_COUNT} طابعاً</Badge>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-20 pt-14 lg:grid-cols-2 lg:pt-20">
          <div className="anim-fade-up text-center lg:text-right">
            ...
            <p className="mx-auto mt-5 max-w-[46ch] text-lg leading-[1.85] text-dim lg:mx-0">
              منيو QR كامل بـ{THEME_COUNT} طابعاً، عربي وإنجليزي — والطلب يصل واتساب
              مطعمك مباشرة <span className="font-bold text-ink">بلا عمولة</span>، أو
              يدفعه زبونك في المنيو نفسه. وبلا تطبيق يحمّله أحد.
            </p>
