...
const FAQ = [
  ...
  },
  {
    ...
    a: "كلاهما متاح للجميع بلا إضافات. فعّلهما من صفحة «الإعدادات»، ثم أضف الأسماء الإنجليزية داخل محرر كل طبق.",
  },
  {
    q: "هل أحتاج دعماً فنياً؟ كيف أتواصل؟",
    a: "من صفحة «الإعدادات» في لوحة التحكم يوجد صندوق الدعم الفني — اكتب طلبك وسيصل لفريقنا مباشرة، وسيظهر الرد في نفس المكان.",
  },
  {
...
/**
 * شروط الاشتراك كما يحتاجها التاجر قبل أن يدفع.
 *
 * ملاحظة: الفاتورة الضريبية للاشتراك غير مفعّلة بعد (تنتظر الرقم الضريبي
 * للمنصة)، ولذلك يذكر البند الأخير الإيصال بلا ادّعاء أنه فاتورة ضريبية.
 */
const POLICY = [
  {
    t: "مدة الاشتراك والتجديد",
    d: "الاشتراك الشهري لمدة ٣٠ يوماً، والسنوي لمدة ١٢ شهراً بسعر ١١ شهراً. لا تجديد تلقائي: ينتهي اشتراكك في تاريخه ونذكّرك قبله، وأنت من يقرّر التجديد.",
  },
  {
    t: "الإلغاء",
    d: "تستطيع إيقاف التجديد في أي وقت من صفحة «الاشتراك» في لوحة التحكم أو بمراسلة الدعم. لا رسوم إلغاء، وتبقى كل مزايا اشتراكك عاملة حتى آخر يوم دفعتَ مقابله.",
  },
  {
    t: "الاسترجاع",
    d: "إن لم تعجبك الخدمة خلال ١٤ يوماً من أول دفعة، راسلنا ونعيد المبلغ كاملاً بلا أسئلة. بعد ذلك لا استرجاع للمدة المستهلكة، ويُستكمل اشتراكك حتى نهايته.",
  },
  {
    t: "ماذا يحدث لمنيوي بعد انتهاء الاشتراك؟",
    d: "بياناتك تبقى محفوظة كما هي — أطباقك وقوائمك وصورك وتحليلاتك. ما يتوقّف هو ظهور المنيو للزبائن، ويعود فوراً بمجرد تجديد الاشتراك. لا نحذف بيانات مطعم بسبب انتهاء اشتراك.",
  },
  {
    t: "الأسعار والضريبة",
    d: "السعر المعروض 99 ر.س شهرياً، وهو شامل ضريبة القيمة المضافة. المنصة تعمل حالياً بمفتاح دفع تجريبي فلا تُخصم مبالغ حقيقية بعد. عند تفعيل الدفع الحقيقي يصلك إيصال مفصّل بكل عملية على بريدك.",
  },
];
  ...
  return (
    <div className="min-h-dvh">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        {/* سياسة الاشتراك — التاجر لا يدفع لمنصة بلا شروط مكتوبة يرجع إليها. */}
        <h2 id="policy" className="mt-12 scroll-mt-20 font-display text-xl font-extrabold text-ink">
        ...
        <Card className="mt-4">
          <dl className="flex flex-col gap-4 text-sm leading-relaxed">
            {POLICY.map((p) => (
              <div key={p.t}>
                <dt className="font-bold text-ink">{p.t}</dt>
                <dd className="mt-1 text-dim">{p.d}</dd>
              </div>
            ))}
          </dl>
        </Card>
